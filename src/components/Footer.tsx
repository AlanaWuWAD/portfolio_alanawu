        ...
        <div className="border-y border-gray-800 p-5 w-full ">
            <div className="flex flex-col md:flex-row md:justify-between items-center">
                ...
                <ul className="flex justify-between items-center ">
                    <HashLink smooth to="/portfolio_alanawu/#about" className="flex-1 relative overflow-hidden group h-7 w-20">
                    ...
                    <HashLink smooth to="/portfolio_alanawu/#skills"  className="flex-1 relative overflow-hidden group h-7 w-20">
                    ...
                    <HashLink smooth to="/portfolio_alanawu/#experience" className="flex-1 relative overflow-hidden group h-7 w-20">
                    ...
                    <HashLink smooth to="/portfolio_alanawu/#project" className="flex-1 relative overflow-hidden group h-7 w-20">
                    ...
                    <HashLink smooth to="/portfolio_alanawu/#contact" className="flex-1 relative overflow-hidden group h-7 w-20">
