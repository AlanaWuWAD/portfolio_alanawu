        ...
        <div className="border-y border-gray-800 p-5 w-full ">
            <div className="flex justify-between items-center">
                ...
                <ul className="flex justify-between items-center">
                    <HashLink smooth to={"/#about"} className="flex-1 relative overflow-hidden group h-7 w-25">
                    ...
                    <HashLink smooth to="/#skills"  className="flex-1 relative overflow-hidden group h-7 w-25">
                    ...
                    <HashLink smooth to="/#experience" className="flex-1 relative overflow-hidden group h-7 w-25">
                    ...
                    <HashLink smooth to="/#project" className="flex-1 relative overflow-hidden group h-7 w-30">
                    ...
                    <HashLink smooth to="/#contsct" className="flex-1 relative overflow-hidden group h-7 w-25">
